...
func (r *AccountRepository) Save(account *domain.Account) error {
	...
	// Execute the SQL statement - Returns a error and row affected
...
func (r *AccountRepository) FindByID(id string) (*domain.Account, error) {
	row := r.db.QueryRow("SELECT id, name, email, api_key, balance, created_at, updated_at FROM accounts WHERE id = ?", id)
